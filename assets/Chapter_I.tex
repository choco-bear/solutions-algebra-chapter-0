...
\problem{
    ...
    Additionally, since the identity morphisms are monomorphisms, there is no identity morhpism in $\cat{C_{nonmono}}$. Therefore, $\cat{C_{nonmono}}$ cannot be a subcategory of $\cat{C}$.
}