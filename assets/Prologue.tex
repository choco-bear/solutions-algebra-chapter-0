...
\begin{itemize}
    \item The solution is \emph{only} hosted on my GitHub page
        \begin{center}
		  \url{https://github.com/choco-bear/algebra-chapter-0-solutions}.
        \end{center} 
    ...
    \item I've tried to reflect errata \url{https://www.math.fsu.edu/~aluffi/algebraerrata.2009/Errata.html} as much as possible.
