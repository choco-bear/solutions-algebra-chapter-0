...
\problem{ %9.12
    ...
    Prove that $H$ contains a subgroup $K$ that is normal in $G$ and such that $\left[G : K\right]$ divides the gcd of $\abs{G}$ and $n!$.
    (In particular, $\left[G : K\right] \leq n!$.) \sqref{IV.2.23}
}{}
