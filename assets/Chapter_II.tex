...
\problem{ %2.1
    $\neg$ One can associate an $n \times n$ matrix $M_\sigma$ with a permutation $\sigma \in S_n$ by letting the entry at $(i,\sigma(i))$ be 1 and letting all other entries be 0. For example, the matrix corresponding to the permutation
    $$ \sigma = \mat{1 & 2 & 3 \\ 3 & 1 & 2} \in S_3 $$
    would be
    $$ M_\sigma = \mat{0 & 0 & 1 \\ 0 & 1 & 0 \\ 1 & 0 & 0}. $$
